module.exports = {
  ...
  rules: {
    ...
    'no-console': 'warn', // disallow the use of 'console` (recommended)
    ...
    'no-debugger': 'warn', // disallow the use of 'debugger` (recommended)
    ...
    'no-undef': 'off', // disallow the use of undeclared variables unless mentioned in '/*global */` comments (recommended)
    ...
    'jsx-quotes': [2, 'prefer-single'], // enforce the consistent use of either double or single quotes in JSX attributes (fixable)
